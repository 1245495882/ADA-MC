...
class MConv(nn.Module):
    ...
    def __init__(self, c1, c2, k=3, s=1, p=None, g=1, d=1, act=True):
        ...
        # Independently handle the convolutional layers for each part
        self.conv1 = nn.Conv2d(c1 // 4, c1 // 4, k, s, autopad(k, p, d), groups=g, dilation=d, bias=False)
        self.conv2 = nn.Conv2d(c1 // 4, c1 // 4, k, s, autopad(k, p, d), groups=g, dilation=d, bias=False)
        self.conv3 = nn.Conv2d(c1 // 4, c1 // 4, k, s, autopad(k, p, d), groups=g, dilation=d, bias=False)
        self.conv4 = nn.Conv2d(c1 // 4, c1 // 4, k, s, autopad(k, p, d), groups=g, dilation=d, bias=False)
